$(document).ready(function() {
    ...
    setTimeout(function() {
        ...
        //animate text
        setTimeout(function() {
            $('#textBody').animate({'font-size': '-=2pt', opacity: 1}, 500);
        }, 500);
        setTimeout(function() {
            $('#textBody p').animate({'font-size': '-=2pt', opacity: 1}, 500);
        }, 1000);
        //hr line
        setTimeout(function() {
            $('hr').animate({width: '50%', opacity: 1}, 1000)
        }, 1500);
        //delay background
        setTimeout(function() {
        ...
        //link images
        setTimeout(function() {
            $('#images img').animate({width: '25px', height: '25px', opacity: 1}, 500)
        }, 2500);
